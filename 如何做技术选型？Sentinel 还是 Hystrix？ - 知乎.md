...
Sentinel 项目地址：[https://github.com/alibaba/Sentinel](https://link.zhihu.com/?target=https%3A//github.com/alibaba/Sentinel)
...
**注**：关于 Hystrix 的详细介绍及代码演示，可以参考本项目[高可用架构](https://zhuanlan.zhihu.com/docs/high-availability/README.md)-Hystrix 部分的详细说明。
...
![](https://pic1.zhimg.com/v2-5bc505b09b40b63acae61c44d8dd6048_b.jpg)
...
![](https://pic4.zhimg.com/v2-2f544e4ea6d1e20fb2e8122cdc607f6b_b.jpg)
...
![](https://pic3.zhimg.com/v2-32fdbb0ba7f00cdbdc1af4a114efd0a2_b.jpg)
...
![](https://pic4.zhimg.com/v2-de06939de3106a60f77b51dfb2c3cd67_b.jpg)
...
Sentinel 目前已经针对 Servlet、Dubbo、Spring Boot/Spring Cloud、gRPC 等进行了适配，用户只需引入相应依赖并进行简单配置即可非常方便地享受 Sentinel 的高可用流量防护能力。未来 Sentinel 还会对更多常用框架进行适配，并且会为 Service Mesh 提供集群流量防护的能力。 
 [https://zhuanlan.zhihu.com/p/112539441](https://zhuanlan.zhihu.com/p/112539441)
